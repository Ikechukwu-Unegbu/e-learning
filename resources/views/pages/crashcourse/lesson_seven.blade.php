  ...
  <div class="container course-holder">
    <div class="course_left">
      ...
      <video width="320" height="240" controls>
        <source src="{{asset('image/videos/7. Centralized Exchange.mp4')}}" type="video/mp4">
        <!-- <source src="movie.ogg" type="video/ogg"> -->
        Your browser does not support the video tag.
      </video>
      <div class="details">
        <div class="title">
          <span id="playing">Playing Now:</span> <span id="current_play">Centralized Exchange</span>
        </div>
        <div class="buttons">
